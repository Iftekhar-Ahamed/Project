...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    $sql_info = "SELECT * FROM `patient` WHERE `ID` = " . $id . " OR `PHONE NUMBER` = " . $id . ";";
        ...
        <form action="update_p.php" method="post">
            <div class="row">
                ...
                <div class="col-sm-6 ">
                    <div class="p-5 py-7">
                        <div class="col-md-13">
                            <p style="font-size:16px; color:black;margin-top:10px;margin-right:30px;">Medicine <a class="text-center btn btn-warning profile-button navbar-right" target="_blank" href="pre_medi.php?pid=<?php echo $id; ?>" style="font-size:16px; color:black;padding: 4px;margin-bottom:10px;">Previous Medicine</a></p>
